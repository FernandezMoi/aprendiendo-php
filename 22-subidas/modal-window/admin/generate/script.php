...
$animationOpen       = ! empty( $param['window_animate'] ) ? $param['window_animate'] : 'drop:direction:left';
$animationClose      = ! empty( $param['window_animate_out'] ) ? $param['window_animate_out'] : 'drop:direction:right';
